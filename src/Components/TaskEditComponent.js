...
export default function TaskEditComponent({ selectedTaskDetails, setSelectedTaskDetails, users, fetchTasks }) {
    ...
    return (
        ...
        <View style={styles.updateSection}>
            ...
            <Text style={styles.taskStatus}>
                CreatedOn: {selectedTaskDetails.createdDate}
            </Text>
            <Text style={styles.taskStatus}>
                Due: {selectedTaskDetails.dueDate}
            </Text>
            <Text style={styles.taskStatus}>
            ...
            {!isEditingTask ? (
                <View>
                    ...
                    <TouchableOpacity
                        style={[styles.submitButton, { backgroundColor: '#00ff08ff' }]}
                        onPress={() => {
                            setSelectedTaskDetails(null);
                        }}
                    >
